...
namespace JicsawPuzzle
{
    public class PieceContainer : MonoBehaviour
    {
        ...
        /// <summary>
        /// Can't Add Real Object.
        /// Only add reserve count +1
        /// </summary>
        /// <returns>If failed add, return false</returns>
        ...
        /// 
        /// </summary>
        /// <param name="targetRectTransfrom"></param>
        /// <returns>If failed add, return false</returns>
        ...
        /// <summary>
        /// Auto Resize gridgroup cellsize.
        /// </summary>
